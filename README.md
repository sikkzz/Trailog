...
- ✅ Fly.io 자동 배포 (main 머지 시)
- ✅ husky 4계층 안전망 (pre-commit, commit-msg, pre-push, CI)
- ✅ Notion 문서 publish 자동화
- ✅ iOS development build (본인 iPhone 검증)
- ⏳ Android development build (집에서 진행 예정)
- ✅ ADR 5건 + 학습 노트 11건+
- ✅ README.md (이 문서)
...
DB 스키마 / 인증 / 사진 업로드 / 이미지 처리 / 지도 / 실시간 — [PROJECT_ROOT 6장 로드맵](./docs/PROJECT_ROOT.md#6-단계별-로드맵)
