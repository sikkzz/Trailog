...
| **5.1**    | **공유 링크** — Share entity (nanoid + 만료 + bcrypt) + `POST/GET/DELETE /shares` + 모바일 공유 UI + **공유 페이지 Next 16 사이드** ([ADR-0016](../decisions/0016-share-page-next16-sidecar.md) `apps/web` 신규 — 풍부 모바일 웹 UX) | 6~7일 | 🚧 진입            |
